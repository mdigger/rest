...
//
// Основные ее достоинства в том, что она достаточно компактная, облегчает некоторые часто
// используемые вещи, поддерживает параметры в пути, совместима со стандартной библиотекой
