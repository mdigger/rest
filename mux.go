...
// Handles добавляет обработчики для указанных путей и методов. В случае, если указанный обработчик
// не может быть приведен к типу поддерживаемых обработчиков, или количество элементов пути больше
// 255, случается panic.
